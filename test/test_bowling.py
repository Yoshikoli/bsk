...
class TestBowlingGame(unittest.TestCase):
    ...
    def test__calculate_score_spare(self):
        game = BowlingGame()
    ...
    def test__calculate_score_strike(self):
        game = BowlingGame()
    ...
    def test__calculate_score_strike_followed_by_spare(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
    ...
    def test__calculate_score_strike_followed_by_strike(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(7, 2))
    ...
    def test__calculate_score_spare_followed_by_spare(self):
        game = BowlingGame()
    ...
    def test__calculate_score_last_frame_spare(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
